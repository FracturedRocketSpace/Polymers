...
#Post processing
weightedEndtoendSq, weightedEndtoendSqStd,  weightedGyradiusSq, weightedGyradiusSqStd, popSize, lp1, fittedWeightedEndtoendSq, fittedGyradius, totalEnergy, totalEnergyCount = postProcess(polymers, polWeights, endtoendDistances);
